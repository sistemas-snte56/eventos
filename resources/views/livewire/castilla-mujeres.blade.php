<main>
    <section class="banner position-relative overflow-hidden" style="background-color: #c2b4d4;">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <div class="block text-center text-lg-start pe-0 pe-xl-5">
                        <h1 class="text-capitalize mb-4" style="color:orangered">Cartilla de Derechos de las Mujeres Y
                            Tejedoras de la Patria</h1>
                        <p class="mb-4"><strong>Programa Nacional Igualdad de Género y Derechos Humanos</strong></p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="ps-lg-5 text-center">
                        <img loading="lazy" decoding="async"
                            src="{{ asset('front/images/temas/cartilla-mujeres@3x.png') }}" alt="banner image"
                            class="w-100">
                    </div>
                </div>
            </div>
        ...
        <div class="has-shapes">
            <svg class="shape shape-left text-light" viewBox="0 0 192 752" fill="none"
                ...
                <path
                    ...
                    stroke="#ee7a00" stroke-width="0.5" stroke-miterlimit="10" />
                <path
    ...
    <section class="section">
        <div class="container">
            ...
            <form wire:submit.prevent="guardar">
                ...
                <div class="row">
                    <p style="color: #ee7a00; font-size: 18px; font-weight: bold; margin-top: 4px;" class="pt-4">
                    ...
                    <div class="col-lg-12 mb-4 pb-2">
                        <div class="form-group">
                            <label for="opcion" class="form-label">
                                ¿Estás afiliado(a) a nuestra organización sindical?
                            </label>
                            <select wire:model.live="opcion" id="opcion" class="form-control">
                                <option value="">-- Elige una respuesta --</option>
                                <option value="si">Sí, pertenezco a la Sección 56 del SNTE</option>
                ...
                @if ($opcion === 'si')
                    ...
                    <div style="background-color: #fff4e5; color: rgba(0, 0, 0, 0.8); padding: 1rem; border-radius: 5px; border: 1px solid #ee7a00;">
                        <strong style="color: #f5942c;">Gracias:</strong> Por favor llena todos los campos solicitados.
                    </div>
                    ...
                    <div class="row">
                        {{-- Select de regiones --}}
                        <div class="form-group col-lg-4 mb-4 pb-2">
                            <label for="selectedRegion" class="form-label">Región</label>
                            <select id="selectedRegion" name="selectedRegion" wire:model.live="selectedRegion"
                                class="form-control">
                        ...
                        <div class="col-lg-8 mb-4 pb-2">
                            <div class="form-group">
                                ...
                                <select id="selectedDelegacion" name="selectedDelegacion" wire:model="selectedDelegacion"
                                    class="form-control">
                                    <option value="">-- Selecciona una delegación --</option>
                                    @foreach ($delegacions as $delegacion)
                                        <option value="{{ $delegacion->id }}">
                                            {{ $delegacion->deleg_delegacional }} - {{ $delegacion->nivel_delegacional }} -
                                            {{ $delegacion->sede_delegacional }}
                                        </option>
                                    @endforeach
                                </select>
                                @error('selectedDelegacion')
                                    <span style="color: red;">{{ $message }}</span>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mb-4 pb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nombre" name="nombre" wire:model.blur="nombre"
                                        class="form-control" placeholder="Ingresa el nombre" autocomplete="given-name">
                                    @error('nombre')
                                        <span style="color: red;">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-4 mb-4 pb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="apaterno" name="apaterno" wire:model.blur="apaterno"
                                        class="form-control" placeholder="Ingresa tu apellido paterno" autocomplete="family-name">
                                    @error('apaterno')
                                        <span style="color: red;">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-4 mb-4 pb-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="amaterno" name="amaterno" wire:model="amaterno" class="form-control"
                                        placeholder="Ingresa tu apellido materno" autocomplete="additional-name">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3  mb-4 pb-2" >
                                <div class="form-group ">
                                    ...
                                    <input type="text" id="rfc" name="rfc" wire:model.blur="rfc" class="form-control"
                                        placeholder="Ingresa tu RFC con homoclave" autocomplete="off">
                                    @error('rfc')
                                        <span style="color: red;">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-5  mb-4 pb-2">
                                <div class="form-group ">
                                    ...
                                    <input type="email" id="email" name="email" wire:model.blur="email"
                                        class="form-control" placeholder="Ingresa tu email" autocomplete="email">
                                    @error('email')
                                        <span style="color: red;">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-4  mb-4 pb-2">
                                <div class="form-group ">
                                    ...
                                    <input type="tel" id="telefono" name="telefono" wire:model.blur="telefono"
                                        class="form-control" maxlength="10" placeholder="Ej. 5512345678" autocomplete="tel">
                                    @error('telefono')
                                        <span style="color: red;">{{ $message }}</span>
                                    @enderror
                                </div>    
